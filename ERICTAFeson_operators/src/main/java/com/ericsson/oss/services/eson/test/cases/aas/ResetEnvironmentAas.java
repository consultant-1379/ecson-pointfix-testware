...
public class ResetEnvironmentAas extends TafTestBase {

    private static final String TEST_CASE_TITLE = "eSON : IDUN-10534_ResetEnvironmentAas - Create ingress and reset database tables.";
    private static final String TEST_ID = "IDUN-10534_AasPipeline";
    private static final String TEST_FILTER = "testCaseId contains 'IDUN-12526_ExecuteAas'";
