...
public class ResetEnvironmentFlm extends TafTestBase {
    ...
    private static final String TEST_FILTER = "testCaseId contains 'SONP-37570_VerifyFlmSuccessfulInstallation'";
